...
1. Read [`docs/product.md`](docs/product.md) to understand what you are building and what is out of scope
2. Read [`docs/architecture.md`](docs/architecture.md) to understand the technology stack and constraints
3. Read [`TASKS.md`](TASKS.md) fresh to confirm the task is unblocked and not already in progress
...
4. Re-read `TASKS.md` immediately before editing it, then move the task to **Ready For Review** when complete, and set **Review assigned to** using the Cross-Agent Review Pairings in [`.agent-workflow.md`](.agent-workflow.md)
